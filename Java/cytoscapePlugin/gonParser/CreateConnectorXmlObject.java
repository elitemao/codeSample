...
// modified from CreateGonConnectorXmlString1
// remove name space

public class CreateConnectorXmlObject {
	public CreateConnectorXmlObject() {
	...
	public static String create(String fromEntityOrProcessLabel,
		...
		try {
			...
			w_process.startElement("", "connector", "", attr1);
			...
			w_process.dataElement("", "firing", "", attr2, "");

			w_process.dataElement("kinetic", "");
			...
			w_process.dataElement("", "processConnector", "", attr3, "");
			w_process.endElement("figure");

			w_process.startElement("targetArrow");
			...
			w_process.dataElement("", "processConnectorArrow", "", attr4, "");

			w_process.endElement("targetArrow");

			w_process.endElement("graphics");

			w_process.endElement("connector");
